...
type RegisterRequest struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // Email of the user to reqister.
...
func (x *LoginRequerst) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginRequerst) ProtoMessage() {}

func (x *LoginRequerst) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginRequerst.ProtoReflect.Descriptor instead.
func (*LoginRequerst) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{2}
}

func (x *LoginRequerst) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *LoginRequerst) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *LoginRequerst) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x121\n" +
	"\x05Login\x12\x13.auth.LoginRequerst\x1a\x13.auth.LoginResponseB\x14Z\x12airat.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*LoginRequerst)(nil),    // 2: auth.LoginRequerst
	(*LoginResponse)(nil),    // 3: auth.LoginResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequerst
